...
<template>
	...
	<div v-else>
		<img
			...
			alt=""
			data-testid="pin"
			class="w-full h-full object-cover rounded-2xl absolute"
		/>
		<div
		...
		>
				...
				<div class="ml-2">
					...
					>
						...
						<div class="h-full overflow-y-auto px-3">
							...
							<div class="bg-transparent hover:bg-slate-400 flex justify-between mb-3">
								<div class="flex">
									<div class="w-16 h-16 rounded-xl bg-gray-800 flex justify-center items-center">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="24"
											height="24"
							...
							<div class="bg-transparent hover:bg-slate-400 flex justify-between mb-3 z-20">
								<div class="flex">
									<div class="w-16 h-16 rounded-xl bg-gray-800 flex justify-center items-center">
										<svg
											xmlns="http://www.w3.org/2000/svg"
					...
					<div class="bg-white w-44 rounded-lg shadow-lg hidden">
						<div class="py-2">
							<div class="hover:bg-slate-100 transition duration-300 mx-2 px-2 py-1.5 rounded-lg">
			...
			<div class="flex justify-between">
				...
				<div class="flex justify-betwe">
					<div class="bg-red-500 w-8 h-8 rounded-full flex justify-center items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
							height="24"
					...
					<div class="bg-red-500 ml-2 w-8 h-8 rounded-full flex justify-center items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
							height="24"
